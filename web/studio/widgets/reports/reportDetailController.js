enablix.studioApp.controller('ReportDetailCtrl', 
	...
	function( $scope,   $state,   $stateParams,   $rootScope,   ReportService,   Notification,   StateUpdateService) {
		...
		if ($scope.reportDef) {
			...
			angular.forEach($scope.reportDef.filters, function(filter) {
				...
				if (filter.defaultValue) {
					...
					var defaultFV = filter.defaultValue();
		...
		/*$scope.data = [
			  ...
			  {
			    "y": "Pigments",
			    "x": "Species presence and absence",
			    "value": 2
			  },
			  {
			    "y": "Pigments",
			    "x": "Species abundance or biomass",
			    "value": 5
			  },
			  {
			    "y": "Pigments",
