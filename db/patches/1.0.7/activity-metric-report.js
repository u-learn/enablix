...
var metricDocs = [{
    ...
    "metricQueryFn" : "function() { var start = new Date(); start.setHours(0,0,0,0); var end = new Date(); end.setHours(23,59,59,999); return db.ebx_activity_audit.count({'activity.accountActivityType':'LOGIN',createdAt: {$gte: ISODate(start.toISOString()) , $lt: ISODate(end.toISOString())}}) } ",
...
},
{
    ...
    "metricQueryFn" : "function() { var start = new Date(); start.setHours(0,0,0,0); var end = new Date(); end.setHours(23,59,59,999); return db.ebx_activity_audit.distinct('actor.userId',{'activity.accountActivityType':'LOGIN', 'createdAt': {$gte: ISODate(start.toISOString()) , $lt: ISODate(end.toISOString())}}).length } ",
    "startDate" : ISODate("2017-04-12T10:44:59.644Z"),
    "runDate" : ISODate("2017-04-18T14:42:00.006Z"),
    "createdAt" : ISODate("2017-04-14T08:12:40.483Z"),
...
},
{
    ...
    "metricQueryFn" : "function() { var start = new Date(); start.setHours(0,0,0,0); var end = new Date(); end.setHours(23,59,59,999); return db.ebx_activity_audit.count({'activity.activityType':'CONTENT_ADD','createdAt': {$gte: ISODate(start.toISOString()) , $lt: ISODate(end.toISOString())}}) } ",
    "startDate" : ISODate("2017-04-12T10:44:59.644Z"),
    "runDate" : ISODate("2017-04-18T14:42:00.006Z"),
    "createdAt" : ISODate("2017-04-14T08:12:40.483Z"),
...
},
{
    ...
    "metricQueryFn" : "function() { var start = new Date(); start.setHours(0,0,0,0); var end = new Date(); end.setHours(23,59,59,999); return db.ebx_activity_audit.count({'activity.activityType':'CONTENT_UPDATE','createdAt': {$gte: ISODate(start.toISOString()) , $lt: ISODate(end.toISOString())}}) }",
    "startDate" : ISODate("2017-04-12T10:44:59.644Z"),
    "runDate" : ISODate("2017-04-18T14:42:00.006Z"),
    "createdAt" : ISODate("2017-04-14T08:12:40.483Z"),
...
},
{
    ...
    "metricQueryFn" : "function() { var start = new Date(); start.setHours(0,0,0,0); var end = new Date(); end.setHours(23,59,59,999); return db.ebx_activity_audit.count({'activity.activityType':'CONTENT_ACCESS','createdAt': {$gte: ISODate(start.toISOString()) , $lt: ISODate(end.toISOString())}}) } ",
    "startDate" : ISODate("2017-04-12T10:44:59.644Z"),
    "runDate" : ISODate("2017-04-18T14:42:00.006Z"),
    "createdAt" : ISODate("2017-04-14T08:12:40.483Z"),
...
},
{
    ...
    "metricQueryFn" : "function() { var start = new Date(); start.setHours(0,0,0,0); var end = new Date(); end.setHours(23,59,59,999); return db.ebx_activity_audit.count({'activity.activityType':'DOC_PREVIEW','createdAt': {$gte: ISODate(start.toISOString()) , $lt: ISODate(end.toISOString())}}) } ",
    "startDate" : ISODate("2017-04-12T10:44:59.644Z"),
    "runDate" : ISODate("2017-04-18T14:42:00.006Z"),
    "createdAt" : ISODate("2017-04-14T08:12:40.483Z"),
...
},
{
    ...
    "metricQueryFn" : "function() { var start = new Date(); start.setHours(0,0,0,0); var end = new Date(); end.setHours(23,59,59,999); return db.ebx_activity_audit.count({'activity.activityType':'DOC_DOWNLOAD','createdAt': {$gte: ISODate(start.toISOString()) , $lt: ISODate(end.toISOString())}}) } ",
    "startDate" : ISODate("2017-04-12T10:44:59.644Z"),
    "runDate" : ISODate("2017-04-18T14:42:00.006Z"),
    "createdAt" : ISODate("2017-04-14T08:12:40.483Z"),
