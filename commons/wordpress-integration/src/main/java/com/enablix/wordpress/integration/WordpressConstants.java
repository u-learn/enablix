...
public class WordpressConstants {
	...
	public static final String INTEGRATION_WORDPRESS_CONFIG_KEY = "integration.wordpress";
	
	public static final String WP_INTEGRATION_PROPERTIES_CONFIG_KEY = "wp.integration.properties";
	
	public static final String INFO_SRC_WP = "Wordpress";
	
	public static final String INFO_TYPE_WP_POST = "WP-Post";
