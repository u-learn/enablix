...
public abstract class Activity {
	...
	public enum ActivityType {
		...
		CONTENT_ADD_SUGGEST(Category.CONTENT, "Content Request Added"), CONTENT_UPDATE_SUGGEST(Category.CONTENT, "Content Request Updated"), 
		CONTENT_SUGGEST_APPROVED(Category.CONTENT, "Content Request Approved"), CONTENT_SUGGEST_REJECT(Category.CONTENT, "Content Request Rejected"), 
