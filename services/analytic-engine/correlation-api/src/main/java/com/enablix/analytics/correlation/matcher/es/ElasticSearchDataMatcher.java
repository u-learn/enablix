...
public class ElasticSearchDataMatcher implements DataMatcher {
	...
	@Override
	public List<Map<String, Object>> findMatchingRecords(String matchItemQId, TemplateFacade template,
	...
	private List<Map<String, Object>> searchMatchingRecords(String matchItemQId, TemplateFacade template,
	...
	@Override
	public List<Map<String, Object>> findMatchingRecords(TemplateFacade template, RelatedItemType relatedItemDef,
	...
	@Override
	public List<Map<String, Object>> findMatchingRecords(TemplateFacade template, PathItemType pathItem,
			MatchInputRecord matchInput) {
